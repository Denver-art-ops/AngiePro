...
Высокую доступность WordPress
Балансировку нагрузки между тремя репликами
Единую базу данных для всех инстансов
Общую файловую систему (uploads, темы, плагины)
Правильную работу сессий и кэширования
